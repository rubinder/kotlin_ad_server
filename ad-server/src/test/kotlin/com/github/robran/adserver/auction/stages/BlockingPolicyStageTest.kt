...
class BlockingPolicyStageTest {
    ...
    @Test
    fun `passes through when no blocks specified`() =
        runTest {
            val candidates =
                listOf(
    ...
    @Test
    fun `drops candidates whose category is in bcat`() =
        runTest {
            val candidates =
                listOf(
    ...
    @Test
    fun `drops candidates whose advertiser domain is in badv`() =
        runTest {
            val candidates =
                listOf(
    ...
    @Test
    fun `bcat matching is exact, not prefix`() =
        runTest {
    ...
    @Test
    fun `returns empty when all candidates are blocked`() =
        runTest {
